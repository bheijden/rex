...
class DummyNode(Node):
    ...
    def default_params(self, rng: jax.Array = None, graph_state: GraphState = None) -> DummyParams:
        """Default params of the node."""
        return DummyParams(99.0, jnp.array([0.0, 1.0]))

    def default_state(self, rng: jax.Array = None, graph_state: GraphState = None) -> DummyState:
        """Default state of the node."""
        return DummyState(step=0, seqs_sum=0, dummy_1=jnp.array([0.0, 1.0]))

    def default_output(self, rng: jax.Array = None, graph_state: GraphState = None) -> DummyOutput:
