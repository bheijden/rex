...
def test_evo():
    ...
    strategy_kwargs = dict(popsize=50, elite_ratio=0.1, sigma_init=0.4, mean_decay=0.)
    ...
    final_state, final_logger, losses = evo(dummy_loss, solver, state, transform, max_steps=max_steps, verbose=True, logger=logger)
