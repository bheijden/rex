...
if __name__ == "__main__":
	...
	if len(args) == 1:
		args += ["--algo", "sac",
		         ...
		         "--env-kwargs", "file: '/home/r2ci/rex/logs/test_2023-01-25-1320/disc_pendulum_ode_train_buffer_phase_awin1_owin2_blocking_advance_compiled_sequential.pkl'",
		         "--eval-env-kwargs", "file: '/home/r2ci/rex/logs/test_2023-01-25-1320/disc_pendulum_ode_eval_buffer_phase_awin1_owin2_blocking_advance.pkl'",
		         "--vec-env", "rex",
		         "--eval-vec-env", "rex",
		         "-optimize",
		         "--n-trials", "500",
